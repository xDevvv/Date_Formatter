      ...
      <div>
        ...
        <div className="flex items-center justify-between mb-2 text-xs">
          ...
          <div className="flex items-center gap-1.5">
            <button onClick={handlePaste} className="flex items-center gap-1 px-2.5 py-1 rounded-md border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 font-medium text-slate-600 dark:text-slate-300 transition-all">
              <Clipboard size={12} /> Paste
            </button>
            <button onClick={handleClear} disabled={!textInput} className="flex items-center gap-1 px-2.5 py-1 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/30 font-medium transition-all disabled:opacity-45">
